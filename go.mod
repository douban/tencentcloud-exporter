...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/mongodb v1.0.334
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/monitor v1.0.334
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/postgres v1.0.334
